...
func (x *CreateAccountRequest) GetAddress() *Address {
	if x != nil {
		return x.Address
	}
	return nil
...
var file_account_proto_rawDesc = []byte{
	...
	0x22, 0xaf, 0x02, 0x0a, 0x07, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x0e, 0x0a, 0x02,
	...
	0x65, 0x73, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x61, 0x63, 0x63, 0x6f,
	0x75, 0x6e, 0x74, 0x2e, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x52, 0x07, 0x61, 0x64, 0x64,
	0x72, 0x65, 0x73, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x18, 0x07,
	...
	0x41, 0x74, 0x22, 0xb6, 0x01, 0x0a, 0x14, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x41, 0x63, 0x63,
	...
	0x73, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x61, 0x63, 0x63, 0x6f, 0x75,
	0x6e, 0x74, 0x2e, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x52, 0x07, 0x61, 0x64, 0x64, 0x72,
	0x65, 0x73, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x18, 0x06, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x06, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x22, 0x27, 0x0a, 0x15, 0x43,
	...
	0x52, 0x02, 0x69, 0x64, 0x22, 0x5d, 0x0a, 0x07, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12,
	...
	0x7a, 0x69, 0x70, 0x32, 0xab, 0x01, 0x0a, 0x0e, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x53,
	...
	0x63, 0x68, 0x72, 0x69, 0x73, 0x2d, 0x68, 0x61, 0x6e, 0x2d, 0x6e, 0x69, 0x68, 0x2f, 0x61, 0x63,
...
var file_account_proto_goTypes = []interface{}{
	...
	(*Address)(nil),               // 5: account.Address
	(*timestamppb.Timestamp)(nil), // 6: google.protobuf.Timestamp
}
var file_account_proto_depIdxs = []int32{
	2, // 0: account.GetAccountResponse.account:type_name -> account.Account
	5, // 1: account.Account.address:type_name -> account.Address
	6, // 2: account.Account.created_at:type_name -> google.protobuf.Timestamp
	6, // 3: account.Account.updated_at:type_name -> google.protobuf.Timestamp
	5, // 4: account.CreateAccountRequest.address:type_name -> account.Address
	0, // 5: account.AccountService.GetAccount:input_type -> account.GetAccountRequest
	3, // 6: account.AccountService.CreateAccount:input_type -> account.CreateAccountRequest
	1, // 7: account.AccountService.GetAccount:output_type -> account.GetAccountResponse
	4, // 8: account.AccountService.CreateAccount:output_type -> account.CreateAccountResponse
